...
static const char font_3x5[][3] = {{0x00, 0x00, 0x00},  //
                                   {0x00, 0x2e, 0x00},  // !
                                   {0x06, 0x00, 0x06},  // "
                                   {0x3e, 0x14, 0x3e},  // #
                                   {0x0c, 0x36, 0x18},  // $
...
void display_putc_5x8(display_t* d, char ch) {
  ...
  for (int x = 0; x < 5; x++)
    for (int y = 0; y < 8; y++)
      d->set_pixel(d, d->x + x, d->y + y,
                   (font_5x8[ch - 0x20][x] & (1 << y)) != 0);
